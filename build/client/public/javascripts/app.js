...
module.exports = {
  ...
  "Add": "Añadir",
  "Cancel": "Anular",
  "photo successfully set as cover": "Exito al fijar la imagen como  portada del album",
  "problem occured while setting cover": "Ocurrió un problema al poner la imagen como portada del album.",
  "pick from computer": "Para añadir imágenes, haga clic aquí o arrastre y pegue sus fotos.",
  "pick from files": "Haga clic aquí para importar imágenes desde la aplicación Archivos.",
  "hidden-description": "No aparecerá en su página de Inicio.\nPero usted puede compartirlo en esta url:",
  "No puede verse desde el lado público.": "No es un recurso público.\"",
  ...
  "modal shared with people msg": "Invite a algunos contactos seleccionados a que accedan. Introduzca\n el email en la casilla y pulse en Enter (para informarles se les enviará un email):",
