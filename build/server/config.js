...
module.exports = {
  common: {
    ...
    afterStart: function(app, server) {
      var err, error, error1, patterns, realtime, uploadFolder, viewEngine;
      app.server = server;
      ...
      try {
        fs.chmodSync(uploadFolder, '0700');
      } catch (error1) {
        err = error1;
        console.log("Something went wrong while setting rights on upload folder");
        console.log(err);
      }
