...
var NotAllowed, NotFound, Photo, app, async, doPipe, downloader, fs, multiparty, photoHelpers, qs, sharing, thumbHelpers, _ref;
...
doPipe = function(req, which, download, res, next) {
  return sharing.checkPermissionsPhoto(req.photo, 'r', req, function(err, isAllowed) {
    var disposition, onError, path, request, _ref1, _ref2;
    if (err || !isAllowed) {
      return next(NotAllowed());
    }
    if (download) {
