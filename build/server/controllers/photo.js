...
var NotAllowed, NotFound, Photo, app, async, doPipe, downloader, fs, multiparty, photoHelpers, qs, ref1, sharing, thumbHelpers;
...
doPipe = function(req, which, download, res, next) {
  return sharing.checkPermissionsPhoto(req.photo, 'r', req, function(err, isAllowed) {
    var disposition, onError, path, ref2, ref3, request;
    if (err || !isAllowed) {
      return next(NotAllowed());
    }
    if (download) {
